...
namespace
{
    ...
    constexpr std::array<ExpectedCategory, 111> kTeenieWeenieCategories {{
        {"JD", "2", "外套", "2.5", "羽绒", Engine::Part::Upper},     {"DM", "2", "外套", "2.5", "羽绒", Engine::Part::Upper},
        {"DL", "2", "外套", "2.5", "羽绒", Engine::Part::Upper},     {"DS", "2", "外套", "2.5", "羽绒", Engine::Part::Upper},
        {"DK", "2", "外套", "2.5", "羽绒", Engine::Part::Upper},     {"DV", "2", "外套", "2.5", "羽绒", Engine::Part::Upper},
        {"JP", "2", "外套", "2.6", "棉服", Engine::Part::Upper},     {"CL", "2", "外套", "2.7", "毛呢", Engine::Part::Upper},
        {"CS", "2", "外套", "2.7", "毛呢", Engine::Part::Upper},     {"CM", "2", "外套", "2.7", "毛呢", Engine::Part::Upper},
        {"CD", "2", "外套", "2.7", "毛呢", Engine::Part::Upper},     {"JJ", "2", "外套", "2.1", "夹克", Engine::Part::Upper},
        {"JA", "2", "外套", "2.1", "夹克", Engine::Part::Upper},     {"JE", "2", "外套", "2.8", "牛仔外套", Engine::Part::Upper},
        {"JW", "2", "外套", "2.7", "毛呢", Engine::Part::Upper},     {"JL", "2", "外套", "2.9", "皮衣", Engine::Part::Upper},
        {"JK", "2", "外套", "2.2", "西装", Engine::Part::Upper},     {"JM", "2", "外套", "2.2", "西装", Engine::Part::Upper},
        {"JT", "2", "外套", "2.3", "风衣", Engine::Part::Upper},     {"JU", "2", "外套", "2.7", "毛呢", Engine::Part::Upper},
        {"VA", "2", "外套", "2.4", "背心", Engine::Part::Upper},     {"VJ", "2", "外套", "2.4", "背心", Engine::Part::Upper},
        {"VL", "2", "外套", "2.4", "背心", Engine::Part::Upper},     {"VM", "2", "外套", "2.4", "背心", Engine::Part::Upper},
        ...
        {"KC", "1", "上衣", "1.5", "毛针织", Engine::Part::Upper},   {"KV", "1", "上衣", "1.5", "毛针织", Engine::Part::Upper},
        {"KA", "1", "上衣", "1.5", "毛针织", Engine::Part::Upper},   {"KK", "1", "上衣", "1.5", "毛针织", Engine::Part::Upper},
        ...
        {"MT", "1", "上衣", "1.2", "卫衣", Engine::Part::Upper},     {"LW", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},
        {"LS", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},      {"LA", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},
        {"RW", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},      {"RS", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},
        {"RA", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},      {"RN", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},
        {"RL", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},      {"LB", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},
        {"RB", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},      {"HB", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},
        {"HN", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},      {"SN", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},
        {"SH", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},      {"SR", "1", "上衣", "1.1", "T恤", Engine::Part::Upper},
        ...
        {"YB", "1", "上衣", "1.3", "衬衫", Engine::Part::Upper},     {"BL", "1", "上衣", "1.3", "衬衫", Engine::Part::Upper},
        {"BN", "1", "上衣", "1.3", "衬衫", Engine::Part::Upper},     {"BW", "1", "上衣", "1.3", "衬衫", Engine::Part::Upper},
        {"YN", "1", "上衣", "1.3", "衬衫", Engine::Part::Upper},     {"TM", "3", "裤子", "3.1", "卫裤", Engine::Part::Lower},
        {"TC", "3", "裤子", "3.2", "休闲裤", Engine::Part::Lower},   {"TH", "3", "裤子", "3.5", "短裤", Engine::Part::Lower},
        {"TG", "3", "裤子", "3.2", "休闲裤", Engine::Part::Lower},   {"TW", "3", "裤子", "3.4", "西装裤", Engine::Part::Lower},
        {"TA", "3", "裤子", "3.2", "休闲裤", Engine::Part::Lower},   {"WH", "3", "裤子", "3.6", "半裙", Engine::Part::Lower},
        {"TK", "3", "裤子", "3.2", "休闲裤", Engine::Part::Lower},   {"TN", "3", "裤子", "3.2", "休闲裤", Engine::Part::Lower},
        {"TV", "3", "裤子", "3.2", "休闲裤", Engine::Part::Lower},   {"TJ", "3", "裤子", "3.3", "牛仔裤", Engine::Part::Lower},
        {"TF", "3", "裤子", "3.5", "短裤", Engine::Part::Lower},     {"AY", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"AC", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"AN", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"AK", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"AW", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"AM", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"AB", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"AF", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"AG", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"AP", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"AS", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"AX", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"FD", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"FT", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"MS", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"OA", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"PP", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"GB", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"GS", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"GD", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"BG", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"PG", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"NB", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"LN", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"FG", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"FJ", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"SX", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"FF", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"QA", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"WS", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"AQ", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
        {"KH", "4", "配件", "4.1", "配饰", Engine::Part::Accessory}, {"ZP", "5", "赠品", "5.1", "赠品", Engine::Part::Accessory},
        {"XP", "4", "配件", "4.1", "配饰", Engine::Part::Accessory},
    }};
...
return {
    ...
    int testTeenieWeenieRule(const QString &rulePath)
    {
        ...
        if (!check(engine.state() == Engine::State::Ready && engine.ruleId() == QStringLiteral("TeenieWeenie") &&
                       engine.ruleVersion() == QStringLiteral("2"),
